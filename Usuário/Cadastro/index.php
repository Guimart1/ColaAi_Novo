...
<body style="background-color: #FFFBE7">
        ...
        <div class="col-md-5 d-flex justify-content-center">
            <div class="formulario rounded-5  p-3 rounded d-flex flex-column sombra">
                ...
                <form method="post" action="process.php" id="formulario" onsubmit="return validarSenha();">
                    ...
                    <!--Confirmar senha-->
                    <div class="orgSenha d-flex">
                        <input required type="password" id="senha1" placeholder="Confirmar senha" name="confirmarSenhaUsuario" class="input-group mb-4">
    ...
    <script src="../../js/verificarSenha.js"></script>
