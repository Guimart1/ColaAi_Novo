...
<body class="fundo-bolinha">
    ...
    <div class="row w-100 d-flex justify-content-center align-items-center g-4" style="height: 80vh;">
        <div class="col-md-7 d-flex justify-content-center align-items-center">
            <img src="../../img/Usuario/login-img.png" class="img-fluid" style="width: 85%;" alt="Crianças pulando">
        </div>
        <div class="col-md-5 d-flex justify-content-center">
            <div class="formulario rounded-5  p-4 rounded d-flex flex-column sombra pt-5 pb-5">
                <!--Titulo-->
                <h1 class="fs-4">Perfil criado com sucesso!</h1>  
                <p class="fs-5">Agora faça o login utilizando as suas credenciais.</p>
                <div class="col-12 d-flex justify-content-end"><a href="../Login/index.php">
