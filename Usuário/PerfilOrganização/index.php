...
<body class="fundo-bolinha2">
    ...
    if (isset($_GET['id'])) {
        ...
        $seguindoOrganizacao = SeguirOrganizacaoDao::selectByOrganizacao(($idOrganizacao));
            ...
            <div class="w-100 d-flex align-items-center justify-content-start" style="height:auto;">
                ...
                <div class="d-flex align-items-start justify-content-center flex-column" style="width: 75%; height: 100px; position:relative; margin-top: 125px;">
                    ...
                    <ul class="m-0 p-0" onclick="modalSeguindo(0,0)" style="list-style: none; font-weight: bold; cursor:pointer;">
                        <li>
                            <h4 style="font-weight: bold; color: #A6A6A6"><?php echo count($seguindoOrganizacao); ?> seguidores</h4>
                        </li>
                    </ul>
        ...
        <div class=" modal-dialog modal-dialog-centered">
            <div class="modal-content rounded rounded-5 pb-4" style="background-color: #F4FFEB;">
                <div class="modal-header border-0 pt-4 m-0 p-0 pb-2 d-flex align-items-center">
                    ...
                    <h1 class="modal-title fs-2" id="exampleModalLabel" style="color: #6D9EAF; font-weight: bold">GUI</h1>
                    <h1 class="modal-title fs-2" id="exampleModalLabel" style="color: #93CC4C; font-weight: bold">DO</h1>
                    <h1 class="modal-title fs-2" id="exampleModalLabel" style="color: #FFD932; font-weight: bold">RES</h1>
                    <button type="button" class="btn-close me-3" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body  pt-0 pb-1">
                    <?php foreach ($seguindoOrganizacao as $seguidores) : ?>
                        <div class="row d-flex mt-4 align-items-center">

                            <div class="col-md-4">
                                <img src="../../img/Usuario/<?= $seguidores['imagemPerfilUsuario']; ?>" class="img-fluid" alt="Foto de Perfil" style="border-radius: 90px; height: 125px; width: 125px;">
                            </div>
                            <div class="col-md-8">
                                <h2 class="fs-5 "><?= $seguidores['nomeUsuario']; ?></h2>
                            </div>
                        </div>
                    <?php endforeach; ?>
                    <!--<div class="row d-flex mt-4 align-items-center">
