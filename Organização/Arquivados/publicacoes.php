...
<body>
    ...
    $publicacao = PublicacaoDao::selectAllByOrganizacaoFiled($idOrganizacaoLogada);
    ...
    <div class="container-fluid vw-100">
        ...
        <div class="row vw-100">
            ...
            <div class="info-box col-md-9 pt-4" style="color: #a6a6a6;" id="data-box">
                <h1 class="text-center">Veja aqui todos as suas Publicações arquivadas!</h1>
                    ...
                    <table class="">
                        <thead>
                            <tr id="data-table">
                                ...
                                <th class="col-md-5 fs-5">Título da Publicação</th>
                                <th class="col-md-1 text-center fs-5">Informações</th>
                                <th class="col-md-1 text-center fs-5">Restaurar</th>
                            </tr>
                            <?php foreach ($publicacao as $publicacoes) : ?>
                                <tr class="mt-1">
                                    <td class="fs-5 pt-3"><?= $publicacoes['idPublicacao']; ?></td>
                                    <td class="fs-5 pt-3"><?= $publicacoes['tituloPublicacao']; ?></td>
