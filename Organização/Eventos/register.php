                    ...
                    <form method="post" action="process.php" enctype="multipart/form-data" class="needs-validation w-100 h-100 p-4" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 needs-validation">
                                ...
                                <input type="text" class="form-control inputGeral" name="cepEvento" id="cepEvento" value="<?=$cep_Evento?>" required onchange="buscarEnderecoPorCEP()" data-mask="00000-000">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-10 needs-validation">
                                <label for="endereco" class="col-form-label">Endereço do Evento*</label>
                                <input type="text" class="form-control inputGeral" placeholder="" name="enderecoEvento" maxlength="100" id="enderecoEvento" value="<?= $endereco_Evento ?>" required>
                            </div>
                            <div class="col-md-2 needs-validation">
                                <label for="numero" class="col-form-label">N°*</label>
                                <input type="text" class="form-control inputGeral" placeholder="" name="numeroEvento" maxlength="5" id="numeroEvento" value="<?= $num_Evento ?>" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 needs-validation">
                                <label for="bairro" class="col-form-label">Bairro do Evento*</label>
                                <input type="text" class="form-control inputGeral" placeholder="" name="bairroEvento" maxlength="100" id="bairroEvento" value="<?= $bairro_Evento ?>">
                            </div>
                            <div class="col-md-6 needs-validation">
                                <label for="complemento" class="col-form-label">Complemento do Evento</label>
                                <input type="text" class="form-control inputGeral" placeholder="" name="complementoEvento" maxlength="100" id="complementoEvento" value="<?= $complemento_Evento ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 needs-validation">
                                <label for="complemento" class="col-form-label">Cidade do Evento*</label>
                                <input type="text" class="form-control inputGeral" placeholder="" name="cidadeEvento" maxlength="100" id="cidadeEvento" value="<?= $cidade_Evento ?>" required>
                            </div>
                            <div class="col-md-6 needs-validation">
                                <label for="complemento" class="col-form-label">UF do Evento*</label>
                                <input type="text" class="form-control inputGeral" placeholder="" name="ufEvento" maxlength="100" id="ufEvento" value="<?= $uf_Evento ?>" required>
                            </div>
                        </div>
                        <div class="row">
